...
#     layer4=tf.layers.max_pooling2d(layer4, 2, 2,'same')
    ...
    with tf.Session() as sess:
        ...
        for i in range(30):
            sess.run(tf.assign(lr,(0.99**i)*0.0001))
...
if __name__=='__main__':
    ...
    more_data1=np.load('D:\\Desktop\\kaggle\\digits_20180122\\more_data_py\\new_data1.npy')
    more_data2=np.load('D:\\Desktop\\kaggle\\digits_20180122\\more_data_py\\new_data2.npy')
...
#     plt.show()
    ...
    x_train,x_test,y_train,y_test=train_test_split(x_train_,y_train_,test_size=0.01)
    acc_list,prediction_output=train_(x_train,x_test,y_train,y_test,x_prediction=x_sum_test)
    plt.plot(acc_list)
    plt.show()
    
with open('D:\\Desktop\\kaggle\\digits_20180122\\kaggle_test_201801290952.csv','w',newline='') as csvfile:
