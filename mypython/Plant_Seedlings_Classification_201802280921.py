...
new_width,new_high=256,256
train_data_path='D:\\Desktop\\kaggle\\Plant_Seedlings_Classification\\train_2\\train_3\\train'
test_data_path='D:\\Desktop\\kaggle\\Plant_Seedlings_Classification\\train_2\\test_3\\test'
...
def train_(x_train,x_test,y_train,y_test):
    ...
    layer7=tf.layers.conv2d(layer6, filters_*64, 3, 1,'same',name='layer7')
...
#     layer8=tf.layers.max_pooling2d(layer8, 2, 2,'same')
    ...
    layer9=tf.reshape(layer7, [-1,2*2*filters_*64])
    
    layer10=tf.layers.dense(layer9, 2048)
