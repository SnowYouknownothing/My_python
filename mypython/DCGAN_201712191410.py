...
with tf.Session() as sess:
    ...
    for epoch in range(1):
        for i in range(550):
            sess.run([g_loss,d_loss],{x:x_real[i*100:(i+1)*100],inputs_fake:x_fake[i*100:(i+1)*100]})
            ...
            print(i)
#     saver.save(sess,'net1/my_net.ckpt')
