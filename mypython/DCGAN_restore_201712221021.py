...
with tf.Session() as sess:
    ...
    x_1=np.random.uniform(-1,1,[100,784])
...
# plt.show()
o_G_outputs=np.reshape(o_G_outputs,[100,28,28])
...
plt.show()
print(o_g_loss,o_d_loss)

# x_real1=minst.train.images
# x_real1=np.reshape(x_real1,[55000,28,28])
# fig,axes=plt.subplots(nrows=5, ncols=20, sharex=True, sharey=True, figsize=(20,5))
# imgs=x_real1[:100]
# for image,row in zip([imgs[:20],imgs[20:40],imgs[40:60],imgs[60:80],imgs[80:100]],axes):
#     for img,ax in zip(image,row):
