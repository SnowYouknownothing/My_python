...
#     f4=tf.nn.dropout(f3,keep_prob=0.5)  
    ...
    conv3=tf.layers.conv2d(layer2, filters=256, kernel_size=3, strides=1, padding='same',name='3')
    pool3=conv3
    ...
    conv4=tf.layers.conv2d(layer3, filters=512, kernel_size=3, strides=1, padding='same',name='4')
    pool4=conv4
...
#     ff4=tf.nn.dropout(ff3,keep_prob=0.5)  
    ...
    conv3_f=tf.layers.conv2d(layer2_f, filters=256, kernel_size=3, strides=1, padding='same',name='3',reuse=True)
    pool3=conv3_f
    pool3=tf.maximum(0.01*pool3,pool3)     
    pool3_f=tf.layers.max_pooling2d(pool3, pool_size=2, strides=2, padding='valid')
    layer3_f=tf.nn.dropout(pool3_f, keep_prob=0.5)   

    conv4_f=tf.layers.conv2d(layer3_f, filters=512, kernel_size=3, strides=1, padding='same',name='4',reuse=True)
    pool4=conv4_f
    pool4=tf.maximum(0.01*pool4,pool4)     
